...
function displayCartItems(productInSessionStorage) {
	...
	if (productInSessionStorage.length > 0) {
		productInSessionStorage.forEach((product) => {
			...
			cartProductQuantity.setAttribute("class", "quantity col-2 col-md-3 text-center");
			...
			removeButton.setAttribute("class", "removeButton border btn pl-4 pr-4");
